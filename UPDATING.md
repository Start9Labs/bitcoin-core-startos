...
- **Bitcoin Core 30.x** — [bitcoin/bitcoin](https://github.com/bitcoin/bitcoin)
  - Latest 30.x release tag:
    ```sh
    gh release list -R bitcoin/bitcoin --limit 50 --json tagName -q '.[].tagName' | grep -E '^v30\.' | head -1
    ```
