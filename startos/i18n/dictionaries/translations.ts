...
export default {
  es_ES: {
    ...
    1513: 'bytes',
    1535: 'Tarifa mínima de retransmisión de transacciones',
    1536: 'Las tasas de tarifa (en BTC/kvB) inferiores a esta se consideran de tarifa cero para la retransmisión, la minería y la creación de transacciones',
    1537: 'Bytes por sigop',
    1538: 'Bytes equivalentes por sigop en las transacciones para la retransmisión y la minería',
    ...
    1757: 'NAT-PMP',
    1758: 'Usar PCP o NAT-PMP para mapear el puerto de escucha.',
    1759: 'Objetivo máximo de subida',
    1760: "Intenta mantener el tráfico saliente por debajo del objetivo indicado, en MiB por cada 24 h. El límite no se aplica a los pares con permiso 'download' ni a los bloques creados en la última semana. 0 = sin límite.",
    1736: 'Habilitar IPC',
  ...
  de_DE: {
    ...
    1513: 'Bytes',
    1535: 'Mindestgebühr für die Weiterleitung',
    1536: 'Gebührensätze (in BTC/kvB) unterhalb dieses Werts gelten beim Weiterleiten, Mining und Erstellen von Transaktionen als gebührenfrei',
    1537: 'Bytes pro Sigop',
    1538: 'Äquivalente Bytes pro Sigop in Transaktionen für Weiterleitung und Mining',
    ...
    1757: 'NAT-PMP',
    1758: 'PCP oder NAT-PMP verwenden, um den Listening-Port weiterzuleiten.',
    1759: 'Maximales Upload-Ziel',
    1760: "Versucht, den ausgehenden Datenverkehr unter dem angegebenen Ziel in MiB pro 24 Stunden zu halten. Das Limit gilt nicht für Peers mit der Berechtigung 'download' und nicht für Blöcke aus der vergangenen Woche. 0 = kein Limit.",
    1736: 'IPC aktivieren',
  ...
  pl_PL: {
    ...
    1256: 'Ustaw maksymalną liczbę połączeń z peerami. Bitcoin rezerwuje 11 z nich na własne połączenia wychodzące; reszta to miejsca przychodzące, dzielone między peerów z internetu a usługi na tym serwerze, które pobierają bloki przez P2P. Minimum utrzymuje ich na tyle dużo wolnych, że jedna z tych usług nadal może zająć miejsce, gdy pozostałe są zajęte. Aby zmniejszyć zużycie łącza, lepiej użyć Maksymalny limit wysyłania (Inne ustawienia), którego limit nie dotyczy tych usług, albo Tylko bloki (Ustawienia Mempool).',
    1257: 'nieograniczony',
    1258: 'Tylko bloki',
    ...
    1513: 'bajty',
    1535: 'Minimalna opłata za przekazywanie transakcji',
    1536: 'Stawki opłat (w BTC/kvB) niższe niż ta są traktowane jako zerowe przy przekazywaniu, wydobywaniu i tworzeniu transakcji',
    1537: 'Bajty na sigop',
    1538: 'Równoważna liczba bajtów na sigop w transakcjach przy przekazywaniu i wydobyciu',
    ...
    1757: 'NAT-PMP',
    1758: 'Użyj PCP lub NAT-PMP do mapowania portu nasłuchu.',
    1759: 'Maksymalny limit wysyłania',
    1760: "Stara się utrzymać ruch wychodzący poniżej podanego limitu w MiB na 24 godziny. Limit nie dotyczy peerów z uprawnieniem 'download' ani bloków utworzonych w ciągu ostatniego tygodnia. 0 = bez limitu.",
    1736: 'Włącz IPC',
  ...
  fr_FR: {
    ...
    1513: 'octets',
    1535: 'Frais minimum de relais des transactions',
    1536: 'Les taux de frais (en BTC/kvB) inférieurs à celui-ci sont considérés comme nuls pour le relais, le minage et la création de transactions',
    1537: 'Octets par sigop',
    1538: 'Octets équivalents par sigop dans les transactions pour le relais et le minage',
    ...
    1757: 'NAT-PMP',
    1758: "Utiliser PCP ou NAT-PMP pour mapper le port d'écoute.",
    1759: "Objectif maximal d'envoi",
    1760: "Tente de maintenir le trafic sortant sous la cible indiquée, en MiB par tranche de 24 h. La limite ne s'applique ni aux pairs disposant de la permission 'download' ni aux blocs créés au cours de la dernière semaine. 0 = aucune limite.",
    1736: 'Activer IPC',
