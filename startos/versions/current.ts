...
The Max OP_RETURN Size field was also showing Bitcoin Core 30's default instead of this version's. It now reads 83 bytes — what Bitcoin Core 28 actually relays — and accepts up to 10,000 again.
...
El campo Tamaño máximo de OP_RETURN también mostraba el valor predeterminado de Bitcoin Core 30 en lugar del de esta versión. Ahora indica 83 bytes —lo que Bitcoin Core 28 retransmite realmente— y vuelve a aceptar hasta 10 000.
...
Das Feld Maximale OP_RETURN-Größe zeigte zudem den Standardwert von Bitcoin Core 30 statt den dieser Version. Es nennt jetzt 83 Bytes — was Bitcoin Core 28 tatsächlich weiterleitet — und akzeptiert wieder bis zu 10.000.
...
Pole Maksymalny rozmiar OP_RETURN pokazywało ponadto wartość domyślną z Bitcoin Core 30 zamiast z tej wersji. Teraz podaje 83 bajty — tyle, ile Bitcoin Core 28 rzeczywiście przekazuje — i ponownie przyjmuje do 10 000.
...
Le champ Taille maximale OP_RETURN affichait par ailleurs la valeur par défaut de Bitcoin Core 30 plutôt que celle de cette version. Il indique désormais 83 octets — ce que Bitcoin Core 28 relaie réellement — et accepte de nouveau jusqu'à 10 000.
